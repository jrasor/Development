...
// TeleOp program that demonstrates PID aided straight drive and turns.

// Y (yellow) commands a continuous straight drive.
// A (green) stops it.
// X (blue) commands a 90 degree left turn
// B (red) commands a 90 degree right turn.
//
...
@TeleOp(name = "Maneuver PID", group = "Exercises")
//@Disabled
public class ManeuverPID extends LinearOpMode {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    while (opModeIsActive()) {
      ...
      // Just drive around to a good starting position.
      //robot.tankDrive();
      robot.simpleDrive();

      // turn 90 degrees left.
      if (xButton) {
        telemetry.addData("command", "X 90\u00B0 left turn.");
      ...
      if (bButton) {
        telemetry.addData("command", "B 90\u00B0 right turn.");
        updateTelemetry(telemetry);
        rotate(-90, 0.3);
      }
